...
public class InfoAsistent {
	...
	public void ShowInfo()
	{
		...
		String result;
		String sql = "select * from asistent_medical where username = '" + username + "';";
		try {
		...
		tipTf.setText(tip);
		String grad = Conexiune.myRs.getString("gradul");
		gradTf.setText(grad);
	...
	private void initialize() {
		...
		JLabel HRLabel = new JLabel("Asistent");
		...
		JLabel lblTipul = new JLabel("Tipul");
		lblTipul.setBounds(93, 433, 56, 16);
		panel_1.add(lblTipul);
		
		tipTf = new JTextField();
		tipTf.setBounds(269, 436, 196, 22);
		panel_1.add(tipTf);
		tipTf.setColumns(10);
