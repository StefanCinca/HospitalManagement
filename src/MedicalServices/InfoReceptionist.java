...
public class InfoReceptionist {
	...
	public void ShowInfo()
	{
		...
		idUnitate = Conexiune.myRs.getInt("unitate_medicala_idUnitate_Medicala");
		IdUnitate.setText(String.valueOf(idUnitate));
	...
	private void initialize() {
		...
		JLabel HRLabel = new JLabel("Receptionist");
		...
		JLabel lblIdUnitate = new JLabel("IdUnitate");
		lblIdUnitate.setBounds(93, 369, 56, 16);
		panel_1.add(lblIdUnitate);
		...
		IdUnitate = new JTextField();
		IdUnitate.setEditable(false);
		IdUnitate.setBounds(269, 365, 196, 22);
		panel_1.add(IdUnitate);
		IdUnitate.setColumns(10);
		
		
		salariuTf = new JTextField();
		salariuTf.setBounds(269, 401, 196, 22);
		panel_1.add(salariuTf);
		salariuTf.setColumns(10);
		
		JLabel lblSalariu = new JLabel("Salariu");
		lblSalariu.setBounds(93, 404, 56, 16);
		panel_1.add(lblSalariu);
		
		JLabel lblNumarOre = new JLabel("Numar ore");
		lblNumarOre.setBounds(93, 439, 71, 16);
		panel_1.add(lblNumarOre);
		
		numarOreTf = new JTextField();
		numarOreTf.setBounds(269, 436, 196, 22);
