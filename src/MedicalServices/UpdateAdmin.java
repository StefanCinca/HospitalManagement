...
public class UpdateAdmin {
	...
	public void GetInfo()
	{
		...
		try 
		{
			String sql = "select * from administrator where CNP like '%" + StringCNP + "%';";
		...
		UpdateButton.addMouseListener(new MouseAdapter()
		{
			public void mouseClicked(MouseEvent e)
			{
				try
				{
					...
					Conexiune.cstmt = Conexiune.con.prepareCall("{call Update_administrator(?,?,?,?,?,?,?,?,?,?,?,?,?)}");
				...
				{
					System.err.println("Nu s-a putut updata administratorul");
				}
			}
		});
