...
public class AsistentSchedule {
	...
	public void GetInfo()
	{
		...
		String result;
		String sql = "select CNP, unitate_medicala_idUnitate_Medicala from asistent_medical where username = '" + username + "';";
		try {
	...
	public void ShowSchedule()
	{
		...
		if (ValideazaAn() == true)
		{
			...
			for (int i = 1; i <= nrZile[nrLuna]; i++)
			{
				...
				int esteConcediu = VerificaConcediu(zi, "asistent_medical");
				if (esteConcediu == 1)
				{
					program = "concediu";
				}
